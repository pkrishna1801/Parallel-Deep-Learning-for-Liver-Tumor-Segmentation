...
class UNET(nn.Module):
    def __init__(self, in_channels=3, classes=1):
        ...
        self.decoder2 = self.__double_conv(self.layers[2], self.layers[1]).to('cuda:0')
        
        self.final_conv = nn.Conv2d(self.layers[1], classes, kernel_size=1).to('cuda:0')
